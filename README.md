...
## The architecture is shown below, and each block is a PE. It can apply W×X matrix multiplication, W means weight, X means input feature map, and their size are 4×16, 16×N, respectivelly. N is an arbitrary number.
...
## The following are the neural network architecture and the size of matrix.
